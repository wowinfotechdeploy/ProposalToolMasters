...
const View_Proposals = () => {
  ...
  const [acceptedPackageIndex, setAcceptedIndex] =
    useState(false);

  const [acceptedPackageName, setAcceptedAcceptedName] =
    useState("");
    ...
    try {
      ...
      if (data?.data?.statusCode === 200) {
        if (data?.data?.responseData?.data) {
          ...
          const ServiceMappingWithPackagesList = data?.data?.responseData?.serviceMappingWithPackagesList;
          ...
          const packageName = packageData.find(item => item.servicePackageID == ModelData.acceptedServicePackageID)
          setAcceptedAcceptedName(packageName?.servicePackageName)
          const packageIndex = packageData.findIndex(item => item.servicePackageID === ModelData.acceptedServicePackageID);
          ...
          if (packageData.length > 0) {
            ...
            setRecurringPricingInfo({
              ...
              DiscountPercentagePackageOne: RecurringDetails[0]?.discountPercentageWithAllDecimal,
              DiscountPercentagePackageTwo: RecurringDetails[1]?.discountPercentageWithAllDecimal,
              DiscountPercentagePackageThree: RecurringDetails[2]?.discountPercentageWithAllDecimal,
            ...
            setOneOffPricingInfo({
              ...
              ,
              DiscountPercentagePackageOne: OneOffDetails[0]?.discountPercentageWithAllDecimal,
              DiscountPercentagePackageTwo: OneOffDetails[1]?.discountPercentageWithAllDecimal,
              DiscountPercentagePackageThree: OneOffDetails[2]?.discountPercentageWithAllDecimal,
          ...
          if (packageData.length !== 0) {
            const updateServicePackages = (services, servicesList, serviceChargeTypeID) => {
              // Filter the services that match the provided serviceChargeTypeID

              const serviceMappings = ServiceMappingWithPackagesList.filter(item => item.serviceChargeTypeID === serviceChargeTypeID);

              return servicesList.map((SelectedService) => {

                // Find matching service mappings for the current SelectedService
                const matchedMappings = serviceMappings.filter(serviceMappingWithPackages => {

                  return serviceMappingWithPackages.serviceCatID === services.serviceCatID &&
                    serviceMappingWithPackages.serviceID === SelectedService.serviceID;
                });
                ...
                matchedMappings.forEach(serviceMappingWithPackages => {
                  ...
                  if (PackageOneID === serviceMappingWithPackages.servicePackageID) {
                    packageOneValue = serviceMappingWithPackages.priceWithAllDecimal !== null
                      ? serviceMappingWithPackages.priceWithAllDecimal
                      : SelectedService.packageOneValue;
                  }

                  //Set Package Two Value
                  if (PackageTwoID === serviceMappingWithPackages.servicePackageID) {
                    packageTwoValue = serviceMappingWithPackages.priceWithAllDecimal !== null
                      ? serviceMappingWithPackages.priceWithAllDecimal
                      : SelectedService.packageTwoValue;
                  }

                  //Set Package Three Value
                  if (PackageThreeID === serviceMappingWithPackages.servicePackageID) {
                    packageThreeValue = serviceMappingWithPackages.priceWithAllDecimal !== null
                      ? serviceMappingWithPackages.priceWithAllDecimal
            ...
            RecurringService = ModelData.reccrunigServiceCatList.map((services) => {
              return {
                ...services,
                servicesList: updateServicePackages(services, services.servicesList, 1) // serviceChargeTypeID for RecurringService is 1
              };
            });
            ...
            OneOffService = ModelData.oneOffServiceCatList.map((services) => {
              return {
                ...services,
                servicesList: updateServicePackages(services, services.servicesList, 2) // serviceChargeTypeID for OneOffService is 2
              };
            });
          }
  ...
  const getFontStyles = (servicePackageID, Type) => {
    ...
    if (Type === "Index") {
      fontWeight = acceptedPackageIndex === servicePackageID && ProposalObject.statusID !== statusID.Declined ? "600" : "400";
      fontSize = acceptedPackageIndex === servicePackageID && ProposalObject.statusID !== statusID.Declined ? "16px" : "14px"; // Adjust font size as needed
    } else {
      fontWeight = servicePackageID === ProposalObject.acceptedServicePackageID && ProposalObject.statusID !== statusID.Declined ? "600" : "400";
      fontSize = servicePackageID === ProposalObject.acceptedServicePackageID && ProposalObject.statusID !== statusID.Declined ? "16px" : "14px"; // Adjust font size as needed
    }
              ...
              <div className="row">
                <div className="col-md-6 col-sm-6 col-6">
                  <div class="prospects-title">
                    <h5>
                      {proposalName}:  {isMobile
                        ? ProposalObject?.quotationName && ProposalObject?.quotationName.length > 15
                                    ...
                                    <div className="tab-content">
                                      <div className="tab-pane p-3 active">
                                        <div className="row">
                                          ...
                                          {ProposalObject.acceptedServicePackageID !== null && ProposalObject.statusID !== statusID.Declined &&
                                                  ...
                                                  <div className="col-lg-4">
                                                    {packageCount == 1 && (
                                                      <input
                                                        ...
                                                        value={
                                                          Number(Math.floor(RecurringPricingInfo.DefaultDiscount * 100) / 100).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                                                        }
                                                      />
                                                    )}
                                                  </div>
                                                        ...
                                                        {selectedPackagesList.map(
                                                          (pkg, index) => (
                                                            <td
                                                              key={index}
                                                              style={{
                                                                fontWeight: getFontStyles(selectedPackagesList[index].servicePackageID, "ID").fontWeight,
                                                                fontSize: getFontStyles(selectedPackagesList[index].servicePackageID, "ID").fontSize
                                                              }}
                                                              ...
                                                              {service.servicesList.map(
                                                                (
                                                                  ...
                                                                  >
                                                                    ...
                                                                    <td style={{
                                                                      fontWeight: getFontStyles(0, "Index").fontWeight,
                                                                      fontSize: getFontStyles(0, "Index").fontSize
                                                                    ...
                                                                    {packageCount >=
                                                                      2 && (
                                                                        <td style={{
                                                                          fontWeight: getFontStyles(1, "Index").fontWeight,
                                                                          fontSize: getFontStyles(1, "Index").fontSize
                                                                        }} className="text-right">
                                                                          {ProposalObject.feeTypeId ===
                                                                            1 ? (
                                                                            <>
                                                                    ...
                                                                    {packageCount ===
                                                                      3 && (
                                                                        <td style={{
                                                                          fontWeight: getFontStyles(2, "Index").fontWeight,
                                                                          fontSize: getFontStyles(2, "Index").fontSize
                                                                        }} className="text-right">
                                                                          {ProposalObject.feeTypeId ===
                                                                            1 ? (
                                                                            <>
                                                          ...
                                                          >
                                                            ...
                                                            >
                                                              <input
                                                                ...
                                                                value={Number(RecurringPricingInfo.DiscountPercentagePackageOne).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                                                style={{
                                                                  width: "100%",
                                                                  textAlign: "right",
                                                                }}
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <input
                                                                  ...
                                                                  type="number" // Change type to number
                                                                  placeholder="Discount (%)"
                                                                  value={Number(RecurringPricingInfo.DiscountPercentagePackageTwo).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <input
                                                                  ...
                                                                  type="number" // Change type to number
                                                                  placeholder="Discount (%)"
                                                                  value={Number(RecurringPricingInfo.DiscountPercentagePackageThree).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                                ...
                                                >
                                                  <div class="col-lg-2 mb-1 col-md-2 col-sm-12 mt-2 text-md-end">
                                                    <div class="mb-1 text-md-end">
                                                      {packageCount == 1 && (<label class="form-label">
                                                        Discount (%)
                                                      </label>
                                                      )}
                                                    </div>
                                                                    ...
                                                                    <td style={{
                                                                      ...
                                                                      {ProposalObject.feeTypeId ===
                                                                        ...
                                                                        <>
                                                                          {" "}
                                                                          {subService.packageOneValue === null ?
                                                                            <span className="fa fa-times"></span> : formatValue(
                                                                              subService.packageOneValue
                                                                            )}
                                                                        </>
                                                                      ) :
                                                          ...
                                                          >
                                                            ...
                                                            >
                                                              <input
                                                                ...
                                                                type="number" // Change type to number
                                                                placeholder="Discount (%)"
                                                                value={Number(OneOffPricingInfo.DiscountPercentagePackageOne).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                                                style={{
                                                                  width: "100%",
                                                                  textAlign: "right",
                                                                }}
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <input
                                                                  ...
                                                                  type="number" // Change type to number
                                                                  placeholder="Discount (%)"
                                                                  value={Number(OneOffPricingInfo.DiscountPercentagePackageTwo).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <input
                                                                  ...
                                                                  type="number" // Change type to number
                                                                  placeholder="Discount (%)"
                                                                  value={Number(OneOffPricingInfo.DiscountPercentagePackageThree).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                                  ...
                                  <tbody>
                                    {officersForm.map((prospect, index) => (
                                      <React.Fragment key={index}>
                                        ...
                                        <tr>
                                          {(ProposalObject.clientMasterBusinessTypeID === 3 || ProposalObject.clientMasterBusinessTypeID === 4 || ProposalObject.clientMasterBusinessTypeID === 5) &&
                                            <>
                                              <td>Authorised </td>
