...
function UserSubscriptionTab(props) {
  ...
  const { scrollUpDownByElementID, setLoader, proposalName, setTopbar, EngagementName, scrollUptoCurrentPosition, getCrudPopUpTitleName, } =
      ...
      if (data?.data?.statusCode === 200) {
        if (data?.data?.responseData?.data) {
          ...
          setSubscriptionPackageObj({
            ...
            discountPercentageYear: ModelData.discountPercentage === null ? 0 : ModelData.discountPercentage,
            discountPercentageMonth: ModelData.discountPercentage === null ? 0 : ModelData.discountPercentage,
            discountPriceYear: ModelData.discountPrice === null ? 0 : ModelData.discountPrice,
            discountPriceMonth: ModelData.discountPrice === null ? 0 : ModelData.discountPrice,
            monthFreeYear: ModelData.monthFree === null ? 0 : ModelData.monthFree,
            monthFreeMonth: ModelData.monthFree === null ? 0 : ModelData.monthFree,
            getMonthsYear: ModelData.getMonths === null ? 0 : ModelData.getMonths,
            getMonthsMonth: ModelData.getMonths === null ? 0 : ModelData.getMonths,
            inPriceOfMonthYear: ModelData.inPriceOfMonth === null ? 0 : ModelData.inPriceOfMonth,
            inPriceOfMonthMonth: ModelData.inPriceOfMonth === null ? 0 : ModelData.inPriceOfMonth
          });
        }
      } else {
  ...
  const SubscriptionPackageAddUpdateBtnClicked = () => {
    ...
    const ApiRequest_ParamsObj = {
      ...
      eSignaturePerMonth:
        subscriptionPackageObj.eSignaturePerMonth === "" ? null : subscriptionPackageObj.eSignaturePerMonth,
      yearlyValuePlan:
      ...
      ...(subscriptionPackageObj.paymentFrequencyID === 1
        ? {
          discountPercentage:
            subscriptionPackageObj.discountPercentageYear === "" ? null : subscriptionPackageObj.discountPercentageYear,
          discountPrice:
            subscriptionPackageObj.discountPriceYear === "" ? null : subscriptionPackageObj.discountPriceYear,
          monthFree:
            subscriptionPackageObj.monthFreeYear === "" ? null : subscriptionPackageObj.monthFreeYear,
          getMonths:
            subscriptionPackageObj.getMonthsYear === "" ? null : subscriptionPackageObj.getMonthsYear,
          inPriceOfMonth:
            subscriptionPackageObj.inPriceOfMonthYear === "" ? null : subscriptionPackageObj.inPriceOfMonthYear,
        }
        : {
          discountPercentage:
            subscriptionPackageObj.discountPercentageMonth === "" ? null : subscriptionPackageObj.discountPercentageMonth,
          discountPrice:
            subscriptionPackageObj.discountPriceMonth === "" ? null : subscriptionPackageObj.discountPriceMonth,
          monthFree:
            subscriptionPackageObj.monthFreeMonth === "" ? null : subscriptionPackageObj.monthFreeMonth,
          getMonths:
            subscriptionPackageObj.getMonthsMonth === "" ? null : subscriptionPackageObj.getMonthsMonth,
          inPriceOfMonth:
            subscriptionPackageObj.inPriceOfMonthMonth === "" ? null : subscriptionPackageObj.inPriceOfMonthMonth,
        }),
    };
                              ...
                              <div className="col-10">
                                <TextField
                                  ...
                                  onChange={(e) => {
                                    ...
                                    // Add commas to the number
                                    inputValue = inputValue;
                                    console.log(subscriptionPackageObj, 'subscriptionPackageObj')
                                    const yearlyValue =
                                      subscriptionPackageObj?.yearlyValuePlan
