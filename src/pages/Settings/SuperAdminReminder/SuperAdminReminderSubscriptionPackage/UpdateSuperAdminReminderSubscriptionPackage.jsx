...
function UpdateFreeSubscriptionPackageReminder() {
  ...
  const handleCancelButton = () => {
    setTopbar("block");
    navigate("/subscription-reminder-list");
  };
  ...
  useEffect(() => {
    ...
    if (location?.state) {
      ...
      setModelAction(location.state?.Action); // If Action is undefined or null, set to "Unpaid"
            ...
            <div className="col-lg-12">
              ...
              <div className="row fieldset modal-footer">
                <div className="col-lg-12 hstack gap-2 justify-content-end text-right mt-3">
                  ...
                  >
                    <span>
                     {getCrudPopUpTitleName(moduleName)}
                    </span>
                  </button>
                </div>
              </div>
...
export default UpdateFreeSubscriptionPackageReminder;
