...
// // Update these with actual values
// const AUTHORIZATION_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjE3MzZkNzQwLTlkMTgtNDUxZC1hNzk1LWFjMGNlMDY1YWEwNiIsIk9yZ2FuaXNhdGlvbklEcyI6IkRGNjA3NjlCLTNDMjAtNEVENi1BNzdCLUZDMEQ2QUJBMEVBRSwgRDg5REE5RkItRUM1RC00QzRBLUFGNUMtMDFFMTUyODU1QUIwIiwibmJmIjoxNzczMDM3MTY2LCJleHAiOjE3NzM2NDE5NjYsImlhdCI6MTc3MzAzNzE2Nn0.qG5C-7XJ8ihZd1bKuLZYnquEDvSX_Jnx-hrOchXoYTI';
// const ACTIVE_ORGANISATION_KEY_ID = 'DF60769B-3C20-4ED6-A77B-FC0D6ABA0EAE'

// const CHAT_API_URL = `${import.meta.env.VITE_API_BASE_URL}/api/chat?organisation_key_id=${ACTIVE_ORGANISATION_KEY_ID}`;
// const TRANSCRIBE_API_ENDPOINT = `${import.meta.env.VITE_API_BASE_URL}/api/transcribe?organisation_key_id=${ACTIVE_ORGANISATION_KEY_ID}`;
