...
function ForgotPassword() {
  ...
  const successMassage = "Forgot your password? No Problem! Please enter your email to reset the password. We will send you reset instructions by email. You may need to check your spam folder or unblock do-not-reply@outbooks.com"
  ...
  return (
    <div style={{ height: "100vh" }}>
      ...
      >
        <div
          className="col-lg-4 card p-2 login-form"
