                    ...
                    <div className="lnnav-bar">
                        <div className="lnlogo">
                            ...
                            <div className="mbMenuCont">
                                ...
                                <div
                                    id="mbMenu"
                                    className={`lnmenu mb-lnmenu ${isMenuVisible ? "show" : "hide"
                                        }`}
                                >
                                    <ul className="lnul">
                                        <li>
                    ...
                    <section className="lnsection-one">
                        <div className="lnhead-panel">
                            <div className="lntext lnleft">
                                <h2 style={{ color: "#fff" }} className="lnh1 martno">Welcome Back</h2>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td vertical-align="middle" width={300} align="center">
                                                <img
                                                    className="left-img-blk"
                                                    src={LoginLogo}
                                                    alt="Proposal Tool Login/Signup"
                                                />
                                                {/* <img className="left-img-blk" alt="Proposl Tool Login/Signup" /> */}
                                            </td>
                                            {/* <td width={25}></td> */}
                                            <td>
